...
public class MoveTo : MonoBehaviour
{
    ...
    public void TransitionFrame(Transform to)
    {
        if (frames.Count > 0)
        {
            ...
            frames.Add(new AnimationKey { from = lastFrame.to, to = to, duration = 2.5f });
        }
        else
        {
            frames.Add(new AnimationKey { fromPoint = Camera.main.transform.position, fromRot = Camera.main.transform.rotation, to = to, duration = 2.5f });
        }
    }
