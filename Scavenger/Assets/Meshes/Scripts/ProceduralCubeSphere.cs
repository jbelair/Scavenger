...
[RequireComponent(typeof(MeshFilter), typeof(MeshRenderer)), ExecuteInEditMode, Obsolete("Use UV Sphere or Icosphere implementation instead", false)]
public class ProceduralCubeSphere : MonoBehaviour
{
    ...
    private void SetVertex(int i, int x, int y, int z)
    {
        ...
        uvs[i] = new Vector2(Mathf.Atan2(normals[i].z, normals[i].x) / (Mathf.PI * 2f), Mathf.Acos(normals[i].y / radius) / (Mathf.PI * 2f));
